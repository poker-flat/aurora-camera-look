...
UltraParser.prototype.parse = function(data) {
    ...
    //return this.parseWffEthernetFixedHeader(data, info);
    return this.parseLtasFrame(data, info);
}
 ...
 * - null
 */
UltraParser.prototype.parseWffEthernetFixedHeader = function(data, info) {
    ...
    return this.parseSipsHeader(data, info);
}
 ...
 * - null
 */
UltraParser.prototype.parseSipsHeader = function(data, info) {
    var sips_header = data.slice(16, 272);
    this.logger.info("SIPS Header: " + sips_header.toString("hex"));

    return this.parseWFFEthernetAddress(data, info);
}
 ...
 * - null
 */
UltraParser.prototype.parseWFFEthernetAddress = function(data, info) {
    ...
    return this.parseWFFEthernetTargetPosition(data, info);
 ...
 * - null
 */
UltraParser.prototype.parseWFFEthernetTargetPosition = function(data, info) {
    ...
    return this.parseWFFEthernetID(data, info);
}
 ...
 * - null
 */
UltraParser.prototype.parseWFFEthernetID = function(data, info) {
    ...
    return this.parseWFFEthernetTimestamp(data, info);
}
 ...
 * - null
 */
UltraParser.prototype.parseWFFEthernetTimestamp = function(data, info) {
 ...
 * - null
 */
UltraParser.prototype.parseLtasFrame = function(data, info) {
    ...
    if (e_sign == 1) {
        ...
        info.e_position = e_position_corrected;
    }
    else {
        info.e_position = e_position;
    }
    ...
    info.position_scale = pos_factor;
    ...
    if (f_sign == 1) {
        ...
        info.f_position = f_position_corrected;
    }
    else {
        info.f_position = f_position;
    }
    ...
    info.velocity_scale = vel_factor;
    ...
    if (g_sign == 1) {
        ...
        info.g_position = g_position_corrected;
    }
    else {
        info.g_position = g_position;
    }
    ...
    if (f_vel_sign == 1) {
        ...
        info.f_velocity = f_velocity_corrected;
    }
    else {
        info.f_velocity = f_velocity;
    }
    ...
    if (e_vel_sign == 1) {
        ...
        info.e_velocity = e_velocity_corrected;
    }
    else {
        info.e_velocity = e_velocity;
    }
    ...
    info.liftoff_flag = liftoff_flag;
    ...
    if (g_vel_sign == 1) {
        ...
        info.g_velocity = g_velocity_corrected;
    }
    else {
        info.g_velocity = g_velocity;
    }
